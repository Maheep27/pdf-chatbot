...
class MultiPage:
    ...
    def add_app(self, title, func, args=None):
        ...
        self.apps.append({"title": title, "function": func, "args": args})
    ...
    def run(self):
        ...
        st.session_state[key] = (
            choice if choice in self.app_names else self.app_names[0]
        )

            
        appname = st.sidebar.radio(
            "Go To", self.app_names, on_change=on_change, key=key
        )
